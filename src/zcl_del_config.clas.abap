CLASS zcl_del_config DEFINITION
  PUBLIC
...
*data application_log_sub_obj1_name.
    ...
    DATA application_log_sub_obj1_name TYPE if_bali_object_handler=>ty_object VALUE 'ZAPP_DEL_01_SUB'.
    DATA application_log_sub_obj1_text TYPE if_bali_object_handler=>ty_object_text VALUE 'Application Log' .
    DATA application_log_object_name TYPE if_bali_object_handler=>ty_object VALUE 'ZAPP_DEL_01_LOG' .
    DATA job_catalog_name TYPE cl_apj_dt_create_content=>ty_catalog_name VALUE 'ZAPP_DEL_01'  .
    DATA job_class_name TYPE cl_apj_dt_create_content=>ty_class_name VALUE 'ZCL_GATENEW_DEL_UPDATE'  .
    DATA job_catalog_text TYPE cl_apj_dt_create_content=>ty_text VALUE 'Demo Application Jobs'  .
    DATA job_template_name TYPE cl_apj_dt_create_content=>ty_template_name VALUE 'ZAPP_DEL_01_TEMPLATE'  .
...
CLASS ZCL_DEL_CONFIG IMPLEMENTATION.
...
*    DATA suffix TYPE string VALUE '02'.
    application_log_sub_obj1_name = |ZAPP_DEL_{ suffix }_SUB|.
    application_log_sub_obj1_text = |Application Log { suffix }| .
    application_log_object_name = |ZAPP_DEL_{ suffix }_LOG|.
    job_catalog_name = |ZAPP_DEL_{ suffix }| .
    job_class_name = |ZCL_GATENEW_DEL_UPDATE| .
    job_catalog_text = |DEL Application Jobs { suffix } |  .
    job_template_name = |ZAPP_DEL_{ suffix }_TEMPLATE| .
    job_template_text = |DEL Application Jobs { suffix } |  .  .
    application_log_object_text = |Application Log of appl job DEL { suffix } | .
